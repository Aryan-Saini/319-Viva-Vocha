...
export const slides2: Slide2[] = [
      ...
      techStack: [
        {
          ...
          technology: 'Next.js',
          purpose: 'All-in-one web framework with batteries included',
        },
        {
          layer: 'Frontend',
          technology: 'shadcn/ui',
          purpose: 'Library for reusable components',
        },
        {
          layer: 'Frontend',
          technology: 'Tailwind CSS',
          purpose: 'Customise components to use our scheme',
        },
        {
          layer: 'Backend',
          technology: 'Prisma',
          purpose: 'TypeScript support and SQL abstraction',
        },
        {
          layer: 'Backend',
          technology: 'BetterAuth',
          purpose: 'Auth library with 2FA, RBAC support',
        },
        {
          layer: 'Backend',
          technology: 'Resend',
          purpose: 'Email service for verification tokens',
        },
        {
          layer: 'Testing',
          technology: 'Vitest',
        ...
        },
        {
          ...
          purpose: 'SQL database for client data',
        },
        {
          layer: 'Storage',
          technology: 'AWS S3',
          purpose: 'File storage for ad-hoc purposes',
        },
        {
          layer: 'Hosting',
          technology: 'AWS (ca-central-1)',
          purpose: 'Canadian cloud hosting for compliance',
        },
      ],
    },
  },
  {
    ...
    content: {
      comparison: {
        ...
        cons: ['Harder to deploy on non-Vercel services including AWS'],
        alternatives: [
          {
            name: 'React + Express',
            pros: [
              'Flexible, lightweight JS bundle',
  ...
  },
  {
    ...
    content: {
      comparison: {
        ...
        cons: ['Manual update/migration via CLI'],
        alternatives: [
          {
            name: 'Material UI',
            pros: ['Enterprise-ready', 'Easier learning curve'],
            cons: [
              'CSS-in-JS runtime slows performance',
              'Entire library shipped in bundle',
              'Hard to customize',
            ],
          },
        ],
  ...
  },
  {
    ...
    content: {
      comparison: {
        ...
        cons: ['Self-hosted auth can lead to security vulnerabilities'],
        alternatives: [
          {
        ...
        alternatives: [
          {
            ...
            cons: [
              'Database hosted in US (dealbreaker)',
              'Limited DB features',
            ],
          },
          {
  ...
  },
  {
    ...
    content: {
      decision: {
        ...
        tradeoffs: {
          lost: ['Schema migrations required for structural changes'],
          gained: [
  ...
  },
  {
    ...
    content: {
      decision: {
        ...
        tradeoffs: {
          lost: ['Not covering every edge case may miss production errors'],
          gained: ['Increased velocity', 'Less workload for team'],
        },
      },
    },
  },
  ...
  },
  {
    ...
    content: {
      uiPage: {
        name: 'Main Dashboard',
        description:
          'Central hub for case workers to manage their daily workflow',
        features: [
  ...
  },
  {
    ...
    content: {
      uiPage: {
        ...
        description:
          'Comprehensive client information management with improved navigation',
        features: [
  ...
  },
  {
    ...
    content: {
      uiPage: {
        ...
        figmaLink:
          'https://app.visily.ai/projects/49c24821-3755-4aac-a28f-2a026bf8660c',
      },
      imageScale: 2,
      imageSrc: 'image9',
    },
      ...
      qnaItems: [
        {
          ...
          answer:
            'Prisma provides excellent TypeScript integration with auto-generated types, reducing runtime errors. Its migration system simplifies database changes, and the team already has experience with it, saving 8-12 hours on the API layer.',
        },
        {
          question:
            "Why not use Vercel for hosting since you're using Next.js?",
          answer:
            "Vercel's database services are hosted in the US, which violates Canadian data residency requirements for healthcare-adjacent data. AWS ca-central-1 ensures all client data stays in Canada for PIPEDA compliance.",
        },
        {
          question:
            'Why self-hosted auth instead of a managed service like Auth0?',
          answer:
            "Most managed auth services (Clerk, Auth0) don't guarantee Canadian data storage. BetterAuth is self-hosted on our AWS infrastructure, ensuring compliance while providing built-in 2FA and RBAC support at zero ongoing cost.",
        },
        {
          question: 'How will you handle the 6-8 week timeline?',
          answer:
            'We prioritized development velocity: monolithic architecture eliminates microservice overhead, Next.js reduces setup time, and manual UI testing (vs automated) lets us iterate faster with client feedback.',
        },
        {
          question:
            'What happens if the system needs to scale beyond 10 users?',
          answer:
            'The monolithic architecture can handle moderate growth. For significant scaling, the clean separation of concerns allows future migration to microservices. PostgreSQL and AWS infrastructure both scale vertically first.',
        },
        {
          question: 'Why strong consistency over availability?',
          answer:
            'For a case management system, data integrity is critical. Stale audit logs could miss unauthorized access, and inconsistent case notes could affect client care. Single-region AWS provides ~99.9% uptime, sufficient for 10 concurrent users.',
        },
      ],
    },
  },
  ...
  },
  {
    ...
    content: {
      imageSrc: 'image15',
      imageCaption:
        'Main page navigation diagrams showing the user journey through the application',
    },
  },
  {
    id: 34,
